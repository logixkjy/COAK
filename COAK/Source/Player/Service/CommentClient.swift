...
struct CommentClient {
    ...
    var postComment: @Sendable (_ videoId: String, _ content: String, _ userId: String, _ email: String) async throws -> Comment
    ...
    var postReply: @Sendable (_ videoId: String, _ commentId: String, _ content: String, _ userId: String, _ email: String) async throws -> Reply
...
extension CommentClient: DependencyKey {
    static let liveValue: CommentClient = .init(
        ...
        postComment: { videoId, content, userId, email in
        ...
        postReply: { videoId, parentId, content, userId, email in
            let docRef = Firestore.firestore()
                .collection("videos").document(videoId)
                .collection("comments").document(parentId)
